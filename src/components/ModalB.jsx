...
const ModalB = () => {
  const initialUrl = `https://contact.mediusware.com/api/country-contacts/United%20States/?page=1`;
  ...
  const debouncedSearch = debounce((searchText) => {
    if (searchText.length) {
      ...
      const url = `https://contact.mediusware.com/api/country-contacts/United%20States/?search=${encodedSearchText}`;
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ display: selectedContact ? "none" : "block", zIndex: "1051" }}
      >
